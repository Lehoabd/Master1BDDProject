...
DROP TABLE IF EXISTS MembreJury CASCADE;
DROP TABLE IF EXISTS Evaluation CASCADE;
DROP TABLE IF EXISTS Dessin CASCADE;
DROP TABLE IF EXISTS ParticipeCompetiteur CASCADE;
DROP TABLE IF EXISTS ParticipeClub CASCADE;
...
DROP TABLE IF EXISTS Evaluateur CASCADE;
